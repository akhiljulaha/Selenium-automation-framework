...
public class LoginPageTest extends BaseTest { // Always extends the Test class with child class, never extend the page
												// clas
	...
	@Test
	public void forgotPwdLinksExistsTest() {
	...
	public void loginTest() {
		accPage = loginPage.doLogin(prop.getProperty("username"), prop.getProperty("password")); // 1 >
