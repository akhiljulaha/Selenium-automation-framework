...
public class RegisterPage {
	...
	public String registeruser(String firstName, String lastName, String email, String telephone, String password,
			String subscribe) {
		eleUtil.waitForElementVisble(this.firstName, AppConstants.MEDIUM_DEFAULT_WAIT); 
		...
		String userRegSuccessMesg = eleUtil.waitForElementVisble(userRegSuccMessg, AppConstants.MEDIUM_DEFAULT_WAIT)
				.getText(); // we can combine 2 pages also but make sure for small text like here we doing
